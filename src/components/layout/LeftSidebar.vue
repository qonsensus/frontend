<template>
  <div class="h-full w-18 border-r flex flex-col items-center">
    ...
    <div class="flex flex-col items-center border-t gap-4 py-4 w-full">
      <Avatar class="border flex items-center justify-center w-11 h-11">
        <AvatarImage src="@/assets/logo.png" />
        <AvatarFallback class="flex items-center justify-center">JD</AvatarFallback>
      </Avatar>
...
import { Settings, Mic, MicOff, Headphones, HeadphoneOff } from 'lucide-vue-next'
